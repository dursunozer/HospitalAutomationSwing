...
public class PatientGUI extends JFrame {
	...
	public PatientGUI(Patient patient) throws SQLException {
		...
		JLabel label = new JLabel("Hosgeldiniz Sayin " + patient.getName());
		...
		w_scrollDoctor.setBounds(10, 23, 239, 252);
		...
		lblPoliklinikAdi.setBounds(271, 66, 126, 25);
		w_appointment.add(lblPoliklinikAdi);

		JComboBox select_Clinic = new JComboBox();
		select_Clinic.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 13));
		select_Clinic.setBounds(271, 93, 126, 22);
		...
		JButton btn_selDoc = new JButton("Doktor Sec");
		btn_selDoc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (row >= 0) {
					...
					HelperMessage.showMsg("Lutfen bir doktor seciniz!");
				}
			}
		});
		btn_selDoc.setFont(new Font("Tahoma", Font.BOLD, 14));
		btn_selDoc.setBounds(64, 286, 126, 23);
		w_appointment.add(btn_selDoc);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(420, 23, 239, 252);
		...
		btn_addAppoint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selRow >= 0) {
					...
					HelperMessage.showMsg("Lutfen gecerli bir tarih seciniz!");
				}
			}
		});
		btn_addAppoint.setFont(new Font("Tahoma", Font.BOLD, 14));
		btn_addAppoint.setBounds(480, 286, 126, 23);
