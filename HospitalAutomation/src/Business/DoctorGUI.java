	...
	public DoctorGUI(Doctor doctor) {
		...
		btn_addWhour.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (date.length() == 0) {
					HelperMessage.showMsg("Lutfen gecerli bir tarih girin");
		...
		btn_deletewhour.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selRow >= 0) {
					...
					HelperMessage.showMsg("Lutfen bir tarih seciniz.");
				}
			}
		});
		...
		w_appointments.setBackground(Color.WHITE);
		...
		JMenuItem deleteMenu = new JMenuItem("�ptal Et");
